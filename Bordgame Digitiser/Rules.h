...
pieceTypes captureOrMove(PlaneState oldState, PlaneState newState, std::vector<cv::Point2i> difference);
...
void selection(PlaneState oldState, PlaneState newState, pieceTypes type, cv::Point2i enPassant_var, std::vector<cv::Point2i> difference);
void rulebreak();
